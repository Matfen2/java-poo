...
| 13 | [Vehicule.java](./testVehicule.java) | Véhicules | Héritage (`extends`), `super`, `afficher()` |
| 14 | [Formes.java](./testFormes.java) | Formes géométriques | Classe abstraite, tableau polymorphe `Forme[]` |
| 15 | [Payment.java](./testPayment.java) | Paiements | Héritage, tableau mixte, `payer()` |
| 16 | [Animals.java](./testAnimals.java) | Système d'animaux | Interfaces multiples (`implements`), `instanceof`, cast |
